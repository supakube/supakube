...
alias watch-tailwind='cd /workspace/crates/web-assets && tailwind-extra -i ./input.css -o ./dist/output.css --watch'
...
alias watch-tailwind-static='cd /workspace/crates/static-website && tailwindcss -i input.css -o dist/tailwind.css --watch'
