...
pub async fn deploy_app_database(
    ...
    let app_database_password: String = insecure_override_passwords.clone().unwrap_or(Uuid::new_v4().to_string());
    let readonly_database_password: String =
        insecure_override_passwords.clone().unwrap_or(Uuid::new_v4().to_string());
    let dbowner_password: String = insecure_override_passwords.clone().unwrap_or(Uuid::new_v4().to_string());
